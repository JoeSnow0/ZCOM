...
#pragma exclude_renderers gles
      ...
      #define MICROSPLAT_SAMPLE_TEX2DARRAY_LOD(tex, u, tc, pN, l) UNITY_SAMPLE_TEX2DARRAY_LOD(tex, u, l)
         ...
         #define MICROSPLAT_SAMPLE_TEX2DARRAY_LOD(tex, uv, tc, pN, l) (UNITY_SAMPLE_TEX2DARRAY_LOD(tex, tc[0], l) * tc[3].x + UNITY_SAMPLE_TEX2DARRAY_LOD(tex, tc[1], l) * tc[3].y + UNITY_SAMPLE_TEX2DARRAY_LOD(tex, tc[2], l) * tc[3].z)
      #endif
...
ENDCG
   ...
   Dependency "BaseMapShader" = "Hidden/MicroSplat/Terrain_Base-1347635300"
