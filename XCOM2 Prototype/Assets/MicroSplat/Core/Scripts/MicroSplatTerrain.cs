...
public class MicroSplatTerrain : MonoBehaviour 
{
   ...
   void Cleanup()
   {
      ...
      {
         terrain.terrainData.baseMapResolution = oldBaseMapSize;
      }
      #endif
   }
   ...
   public void Sync()
   {
      ...
      {
         blendMat.CopyPropertiesFromMaterial(m);
         ...
         blendMat.SetVector("_TerrainBounds", bnds);
         blendMat.SetTexture("_TerrainDesc", terrainDesc);
      }
